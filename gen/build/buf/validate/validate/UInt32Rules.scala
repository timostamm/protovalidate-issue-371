...
final case class UInt32Rules(
    ...
    lessThan: build.buf.validate.validate.UInt32Rules.LessThan = build.buf.validate.validate.UInt32Rules.LessThan.Empty,
    greaterThan: build.buf.validate.validate.UInt32Rules.GreaterThan = build.buf.validate.validate.UInt32Rules.GreaterThan.Empty,
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UInt32Rules] with _root_.scalapb.ExtendableMessage[UInt32Rules] {
    @transient
    ...
    def withLt(__v: _root_.scala.Int): UInt32Rules = copy(lessThan = build.buf.validate.validate.UInt32Rules.LessThan.Lt(__v))
    def getLte: _root_.scala.Int = lessThan.lte.getOrElse(0)
    def withLte(__v: _root_.scala.Int): UInt32Rules = copy(lessThan = build.buf.validate.validate.UInt32Rules.LessThan.Lte(__v))
    def getGt: _root_.scala.Int = greaterThan.gt.getOrElse(0)
    def withGt(__v: _root_.scala.Int): UInt32Rules = copy(greaterThan = build.buf.validate.validate.UInt32Rules.GreaterThan.Gt(__v))
    def getGte: _root_.scala.Int = greaterThan.gte.getOrElse(0)
    def withGte(__v: _root_.scala.Int): UInt32Rules = copy(greaterThan = build.buf.validate.validate.UInt32Rules.GreaterThan.Gte(__v))
    ...
    def addExample(__vs: _root_.scala.Int *): UInt32Rules = addAllExample(__vs)
    def addAllExample(__vs: Iterable[_root_.scala.Int]): UInt32Rules = copy(example = example ++ __vs)
    def withExample(__v: _root_.scala.Seq[_root_.scala.Int]): UInt32Rules = copy(example = __v)
    def clearLessThan: UInt32Rules = copy(lessThan = build.buf.validate.validate.UInt32Rules.LessThan.Empty)
    def withLessThan(__v: build.buf.validate.validate.UInt32Rules.LessThan): UInt32Rules = copy(lessThan = __v)
    def clearGreaterThan: UInt32Rules = copy(greaterThan = build.buf.validate.validate.UInt32Rules.GreaterThan.Empty)
    def withGreaterThan(__v: build.buf.validate.validate.UInt32Rules.GreaterThan): UInt32Rules = copy(greaterThan = __v)
    ...
    def companion: build.buf.validate.validate.UInt32Rules.type = build.buf.validate.validate.UInt32Rules
    // @@protoc_insertion_point(GeneratedMessage[buf.validate.UInt32Rules])
}

object UInt32Rules extends scalapb.GeneratedMessageCompanion[build.buf.validate.validate.UInt32Rules] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[build.buf.validate.validate.UInt32Rules] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): build.buf.validate.validate.UInt32Rules = {
    ...
    var __lessThan: build.buf.validate.validate.UInt32Rules.LessThan = build.buf.validate.validate.UInt32Rules.LessThan.Empty
    var __greaterThan: build.buf.validate.validate.UInt32Rules.GreaterThan = build.buf.validate.validate.UInt32Rules.GreaterThan.Empty
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 8 =>
          __const = _root_.scala.Option(_input__.readUInt32())
        case 16 =>
          __lessThan = build.buf.validate.validate.UInt32Rules.LessThan.Lt(_input__.readUInt32())
        case 24 =>
          __lessThan = build.buf.validate.validate.UInt32Rules.LessThan.Lte(_input__.readUInt32())
        case 32 =>
          __greaterThan = build.buf.validate.validate.UInt32Rules.GreaterThan.Gt(_input__.readUInt32())
        case 40 =>
          __greaterThan = build.buf.validate.validate.UInt32Rules.GreaterThan.Gte(_input__.readUInt32())
        case 48 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[build.buf.validate.validate.UInt32Rules] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      build.buf.validate.validate.UInt32Rules(
        ...
        lessThan = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).flatMap(_.as[_root_.scala.Option[_root_.scala.Int]]).map(build.buf.validate.validate.UInt32Rules.LessThan.Lt(_))
            .orElse[build.buf.validate.validate.UInt32Rules.LessThan](__fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).flatMap(_.as[_root_.scala.Option[_root_.scala.Int]]).map(build.buf.validate.validate.UInt32Rules.LessThan.Lte(_)))
            .getOrElse(build.buf.validate.validate.UInt32Rules.LessThan.Empty),
        greaterThan = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).flatMap(_.as[_root_.scala.Option[_root_.scala.Int]]).map(build.buf.validate.validate.UInt32Rules.GreaterThan.Gt(_))
            .orElse[build.buf.validate.validate.UInt32Rules.GreaterThan](__fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).flatMap(_.as[_root_.scala.Option[_root_.scala.Int]]).map(build.buf.validate.validate.UInt32Rules.GreaterThan.Gte(_)))
            .getOrElse(build.buf.validate.validate.UInt32Rules.GreaterThan.Empty)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ValidateProto.javaDescriptor.getMessageTypes().get(9)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ValidateProto.scalaDescriptor.messages(9)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = build.buf.validate.validate.UInt32Rules(
    const = _root_.scala.None,
    in = _root_.scala.Seq.empty,
    notIn = _root_.scala.Seq.empty,
    example = _root_.scala.Seq.empty,
    lessThan = build.buf.validate.validate.UInt32Rules.LessThan.Empty,
    greaterThan = build.buf.validate.validate.UInt32Rules.GreaterThan.Empty
  )
  ...
  object LessThan {
    @SerialVersionUID(0L)
    case object Empty extends build.buf.validate.validate.UInt32Rules.LessThan {
    ...
    @SerialVersionUID(0L)
    final case class Lt(value: _root_.scala.Int) extends build.buf.validate.validate.UInt32Rules.LessThan {
    ...
    @SerialVersionUID(0L)
    final case class Lte(value: _root_.scala.Int) extends build.buf.validate.validate.UInt32Rules.LessThan {
      type ValueType = _root_.scala.Int
  ...
  object GreaterThan {
    @SerialVersionUID(0L)
    case object Empty extends build.buf.validate.validate.UInt32Rules.GreaterThan {
      type ValueType = _root_.scala.Nothing
      override def isEmpty: _root_.scala.Boolean = true
      override def isDefined: _root_.scala.Boolean = false
      override def number: _root_.scala.Int = 0
    ...
    @SerialVersionUID(0L)
    final case class Gt(value: _root_.scala.Int) extends build.buf.validate.validate.UInt32Rules.GreaterThan {
      type ValueType = _root_.scala.Int
    ...
    @SerialVersionUID(0L)
    final case class Gte(value: _root_.scala.Int) extends build.buf.validate.validate.UInt32Rules.GreaterThan {
      type ValueType = _root_.scala.Int
  ...
  implicit class UInt32RulesLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, build.buf.validate.validate.UInt32Rules]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, build.buf.validate.validate.UInt32Rules](_l) {
    ...
    def lt: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Int] = field(_.getLt)((c_, f_) => c_.copy(lessThan = build.buf.validate.validate.UInt32Rules.LessThan.Lt(f_)))
    def lte: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Int] = field(_.getLte)((c_, f_) => c_.copy(lessThan = build.buf.validate.validate.UInt32Rules.LessThan.Lte(f_)))
    def gt: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Int] = field(_.getGt)((c_, f_) => c_.copy(greaterThan = build.buf.validate.validate.UInt32Rules.GreaterThan.Gt(f_)))
    def gte: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Int] = field(_.getGte)((c_, f_) => c_.copy(greaterThan = build.buf.validate.validate.UInt32Rules.GreaterThan.Gte(f_)))
    ...
    def lessThan: _root_.scalapb.lenses.Lens[UpperPB, build.buf.validate.validate.UInt32Rules.LessThan] = field(_.lessThan)((c_, f_) => c_.copy(lessThan = f_))
    def greaterThan: _root_.scalapb.lenses.Lens[UpperPB, build.buf.validate.validate.UInt32Rules.GreaterThan] = field(_.greaterThan)((c_, f_) => c_.copy(greaterThan = f_))
  }
  ...
  def of(
    ...
    lessThan: build.buf.validate.validate.UInt32Rules.LessThan,
    greaterThan: build.buf.validate.validate.UInt32Rules.GreaterThan,
    in: _root_.scala.Seq[_root_.scala.Int],
    notIn: _root_.scala.Seq[_root_.scala.Int],
    example: _root_.scala.Seq[_root_.scala.Int]
  ): _root_.build.buf.validate.validate.UInt32Rules = _root_.build.buf.validate.validate.UInt32Rules(
    const,
    lessThan,
    greaterThan,
    in,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[buf.validate.UInt32Rules])
}
